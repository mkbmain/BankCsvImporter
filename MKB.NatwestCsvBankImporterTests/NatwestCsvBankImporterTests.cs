...
namespace MKB.NatwestCsvBankImporterTests
{
    public class NatwestCsvBankImporterTests
    {
        ...
        public void Ensure_data_parsed_back_returns_a_correct_model()
        {
            ...
            var sut = new NatwestCsvBankImporter.NatwestCsvBankImporter(fileWrapper.Object, csvSplitter.Object);
        ...
        public void Ensure_if_file_path_is_invalid_we_throw_arguement_exception()
        {
            ...
            var sut = new NatwestCsvBankImporter.NatwestCsvBankImporter(fileWrapper.Object, null);
